                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">Sant Tukaram Nagar, Pimpri, Pune</span> <br>
										<span class="text-white">Sant Tukaram Nagar, Pimpri, Pune</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+91 9523698552</span>
										<span class="text-white">+91 9523698552 </span>
									</div>
                                </li>
